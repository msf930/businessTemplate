...
const Index = () => {
    return (
        <div className="testContainer">
            <div>
                <h1 className="testTitle">Satisfied Customers</h1>
            </div>
            <div className="testItemContainer">

                <div className="testItem">
                    <div className="testIconContainer">
                    ...
                    <p className="testP">“I'm a testimonial.
                    ...
                    <h1 className="testName">Jane Doe</h1>
                </div>
                <div className="testItem">
                    <div className="testIconContainer">
                        <svg preserveAspectRatio="xMidYMid meet" data-bbox="-0.02 -0.005 54.82 38.305" xmlns="http://www.w3.org/2000/svg" viewBox="-0.02 -0.005 54.82 38.305" role="presentation" aria-hidden="true" aria-label="">
                    ...
                    <h1 className="testName">Tom Cruise</h1>
                </div>
                <div className="testItem">
                    <div className="testIconContainer">
                        <svg preserveAspectRatio="xMidYMid meet" data-bbox="-0.02 -0.005 54.82 38.305" xmlns="http://www.w3.org/2000/svg" viewBox="-0.02 -0.005 54.82 38.305" role="presentation" aria-hidden="true" aria-label="">
                    ...
                    <h1 className="testName">Clint Eastwood</h1>
                </div>
